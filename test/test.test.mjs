...
function adicionarRegistro(nome, email, senha) {
    i++;
    const pessoa = { iden: i, nome, email, senha };
...
describe('Função de Cadastro', () => {
    beforeEach(() => {
        ...
        i = 5;
        registros = [
            { iden: 1, nome: 'User1', email: 'user1@test.com', senha: 'pass1' },
            { iden: 2, nome: 'User2', email: 'user2@test.com', senha: 'pass2' },
            { iden: 3, nome: 'User3', email: 'user3@test.com', senha: 'pass3' },
            { iden: 4, nome: 'User4', email: 'user4@test.com', senha: 'pass4' },
            { iden: 5, nome: 'User5', email: 'user5@test.com', senha: 'pass5' },
        ];
    });
    ...
    it('deve adicionar um novo registro corretamente', () => {
        ...
        expect(pessoa).to.include({ nome, email, senha });
